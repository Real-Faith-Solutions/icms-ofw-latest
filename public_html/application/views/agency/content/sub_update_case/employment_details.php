...
<!-- OSAEC CODE END OLD CODE -->

<!-- OSAEC CODE START SUB_UPDATE EMPLOYMENT DETAIL'S -->
            ...
            <div class="tab-content tab-inner px-0 pt-0 " >
                <form id="form-update_employment_info_local" onSubmit="return false;" >
                    ...
                    <div class="form-content">
                                        ...
                                        <div class="inner-form-body py-3">
                                            <div class="row">
                                                <div class="form-group col-lg-6 col-md-6 col-sm-6" style="display: none;">
                                                    ...
                                                    <select id="emp-act_employed_unemployed" disabled class="form-control emp-employed_unemployed sel-employed_unemployed">
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 col-sm-12 form-currency">
                                                    ...
                                                    <select id="emp-act_type_of_child_cases" disabled class="form-control emp-type_of_child_cases sel-type_of_child_cases">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-4 col-md-4  col-sm-12">
                                                    ...
                                                    <input type="text" maxlength="20" id="emp-reasons_for_employment" disabled name="emp_act_reasons_for_employment" class="form-control emp-act_reasons_for_employment">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="content-footer float-right">
                            <button class="btn btn-update pull-left " id="btn-manage-local_employer">Manage</button>
                            <button class="btn btn-update pull-left hide" id="btn-save-local_employer">Save</button>
                        </div>
                    </div>
                </form>
            </div>
...
<!-- OSAEC CODE END SUB_UPDATE EMPLOYMENT DETAIL'S -->
