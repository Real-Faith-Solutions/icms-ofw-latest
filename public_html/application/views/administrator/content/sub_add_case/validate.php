...
<div class="card col-md-12">
    <div class="card-header card-sub-title bg-white">
        ...
        <small class="card-desc"> Provide the required details to validate if there exists the same case or report.
        </small>
    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row mx-2">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="text" maxlength="50" class="form-control v-first_name letNumDash"
                    ...
                    <div class="row mx-2">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="text" maxlength="50" class="form-control v-last_name lettersOnly"
                    ...
                    <div class="row mx-2">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="text" class="form-control v-dob datepicker" name="v_dob"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="row mx-2">
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 form-currency hide">
                            ...
                            <input type="text" name="v_deployed_date" class="form-control datepicker v-deployed_date"
                                placeholder="MM/DD/YYYY">
                        </div>
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="card col-md-12 ">
                        <div>
                            <button type="submit"
                                class="btn btn-secondary-light_blue  btn-validate float-right">Validate</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row  card-validate" style="display: none" id="div-match_result">
    <div class="card col-md-12">

        <!--SHOW MATCHES IN VALIDATING CASE-->
        <!--note: don't erase inline style it's for js function-->
        <div class="inner-box m-0 matched_contents" style="display: none">
            <div class="row form-row">

                <div class="col-lg-12 col-md-12 col-sm-12 card-sub-title blue pl-3"> Matched Results <span
                        class="matched_count"></span><br>
                    <small class="card-desc">Please see matched results from the list </small>
                </div>

                <div class="col-lg-12 col-md-12 col-sm-12">

                    <div class="inner-box matched_results" style="display: none">
                        <table class="table">
                    ...
                    <div class="inner-box matched_none" style="display: none">
                        <div class="no-contact_person">
                            <div class="container-fluid text-center" id="no-data_found">
                                ...
                                <div class="nd-body">
                                    <h5 class="nd-body-content ">NO MATCHED REPORT/VICTIM FOUND</h5>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="form-actions">
    <div class="row">
        <div class="card col-md-12">
            <div>
                <button type="submit" class="btn btn-primary-orange btn-next btn-next_tab float-right btn-fr_validate"
                    style="display: none;">Add new report</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade bd-example-modal-lg" id="mdl-victim-details1" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="vic-victim_info_dob ml-5"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4col-sm-4 ">
                        <div class="card-title">
                            <button type="button"
                                class="btn btn-secondary-light_blue float-right mrg-t-n-10 validate-add-new-btn"><i
                                    class="fa fa-plus"></i> Add New Case</button>
                        </div>
                    </div>
                </div>
...
<div class="modal fade  modal-manage " id="mdl-victim-details" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-content ">
            <div class="modal-header p-0 modal-left d-block">
                <h5 class="modal-title h5-title msgmodal-header text-normal">
                    List of case for <span class="spn_victim">victim : <span class="content-title vic-name">-</span>
                    </span>
                </h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary-orange validate-add-new-btn" data-dismiss="modal">Add new
                    report for this victim</button>
