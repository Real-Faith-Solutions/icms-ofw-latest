...
<!-- ####---- IACAT INCIDENT DETAILS END ----#### -->


<!-- ####---- OSAEC INCIDENT DETAILS START ----#### -->
                    ...
                    <div class=" px-3">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                ...
                                <textarea class="form-control valid noSpcStart case-complainant_place_of_incident" rows="4" maxlength="100" aria-invalid="false"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class=" card card_tbl-container ">
                                            <div class="row">
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <textarea class="form-control case-case_summary noSpcStart" maxlength="5000" style="height: 150px !important;"  placeholder="Case Summary..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>-->
...
<div class="modal modal-xl fade bd-example-modal-xl" id="modal-update_case_offender" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title " id="">Update Alleged Offender</h5>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="offender_field_other" style="display: none;">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Alias</label>
                                    <input type="text" class="form-control u-case-offender_name" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Place of Birth</label>
                                    <input type="text" class="form-control u-case-offender_place_of_birth" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Date of Birth</label>
                                    <input type="text" class="form-control u-case-offender_date_of_birth datepicker" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Occupation</label>
                                    <input type="text" class="form-control u-case-offender_date_place_of_birth" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Principal Place of Business</label>
                                    <input type="text" class="form-control u-case-offender_principal_place_of_business" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Gender</label>
                                    <select class="form-control sel-sex u-case-offender_gender">
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Religion</label>
                                    <input type="text" class="form-control u-case-offender_religion" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Race/ethnicity</label>
                                    <input type="text" class="form-control u-case-offender_race_ethnicity" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Civil Status</label>
                                    <select class="form-control sel-civil u-case-offender_civil_status" >
                                        <option selected="">Civil Status</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Previous case/Violation committed</label>
                                    <input type="text" class="form-control u-case-offender_previous_case_committed" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Name of Parents</label>
                                    <input type="text" class="form-control u-case-offender_name_of_parents" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Name of Spouse if Married</label>
                                    <input type="text" class="form-control u-case-offender_name_of_spouse" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Social Media Account/Platform</label>
                                    <input type="text" class="form-control u-case-offender_social_media_account" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Email Address</label>
                                    <input type="email" class="form-control u-case-offender_email_address" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Place of arrest (If arrested)</label>
                                    <input type="text" class="form-control u-case-offender_place_of_arrest" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Date of arrest (If arrested)</label>
                                    <input type="text" class="form-control u-case-offender_date_of_arrest datepicker" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>If offender is at large</label>
                                    <select class="form-control u-case-offender_at_large" >
                                        <option>Body Build</option>
                                        <option>Height</option>
                                        <option>Identifying Marks</option>
                                    </select>
