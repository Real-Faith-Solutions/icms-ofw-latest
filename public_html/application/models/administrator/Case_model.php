...
//          echo $sql; exit();
    ...
    public function addVictim($aParam) {
        $sql = "
                ...
                SET 
                    ...
                    `victim_ethnic_group`= " . $this->yel->checkifStringExist($aParam['victim_personal_info']['ethnic_group_value']) . ",
    ...
    public function __addVictimInfo($aParam) {
        ...
        $sql = "
                ...
                `victim_info_disability`= " . $this->yel->checkDateIfExist($aParam['victim_personal_info']['disability']) . ",
        ...
        $sql = "
                ...
                `victim_info_disability`= " . $this->yel->checkDateIfExist($aParam['victim_personal_info']['assumed_disablity']) . ",
